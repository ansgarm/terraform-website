...
| Status  | Response                                                      | Reason                                                                       |
| ------- | ------------------------------------------------------------- | ---------------------------------------------------------------------------- |
| [200][] | [JSON API document][] (`type: "notification-configuration"`) | Successfully updated the notification configuration                          |
| [400][] | [JSON API error object][]                                     | Unable to complete verification request to destination URL                   |
...
| Status  | Response                                                      | Reason                                                     |
| ------- | ------------------------------------------------------------- | ---------------------------------------------------------- |
| [200][] | [JSON API document][] (`type: "notification-configuration"`) | Successfully verified the notification configuration       |
| [400][] | [JSON API error object][]                                     | Unable to complete verification request to destination URL |
